                    ...
                    <div class="padding-vertical padding-xxlarge">
                        ...
                        <div class="padding-top padding-medium">
                            <div class="footer12_bottom-wrapper">
                                <div class="footer12_credit-text font-bold">© 2024 Aviada Labs. All rights reserved.</div>
                                <div class="w-layout-grid footer12_social-list"><a href="#"
                                        class="footer12_social-link w-inline-block">
                                        <div class="icon-embed-xsmall w-embed text-white"><svg width="100%" height="100%"
