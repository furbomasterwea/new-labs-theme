<?php
/* Template Name: Contact aviada relume */
get_header();
?>
...
<section
    ...
    <div data-slot="card"
        ...
        <a href="#"><img src="https://d22po4pjz3o32e.cloudfront.net/logo-image.svg" alt="Relume placeholder logo" /></a>
                ...
                <div
                    ...
                    <div class="relative">
                        ...
                        <nav class="static flex w-full min-w-full flex-col overflow-hidden border-0 border-scheme-border bg-scheme-background p-0 whitespace-nowrap lg:absolute lg:overflow-visible lg:border lg:p-2 lg:[--height:auto] lg:[--opacity-close:0%] lg:[--opacity-open:100%] lg:[--translate-y-close:25%] lg:[--translate-y-open:0%]"
                            ...
                            <a href="#" class="px-0 py-3 text-center lg:px-4 lg:py-2 lg:text-left">Link Five</a><a
                                href="#" class="px-0 py-3 text-center lg:px-4 lg:py-2 lg:text-left">Link Six</a><a
                                href="#" class="px-0 py-3 text-center lg:px-4 lg:py-2 lg:text-left">Link Seven</a>
                        </nav>
                    </div>
                </div>
            </div>
        ...
        <div
            ...
            <div class="grid grid-flow-col grid-cols-[max-content] items-start justify-start gap-x-3">
                <a href="#"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                        ...
                        viewBox="0 0 24 24" class="size-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <path
